...
{
    public int Rent(int price, int quantity, int days);
}

public interface ticket
{
    public int Price(int price, int customer_age);
}
...
public class PublicBuilding : Building, ticket
{
...
public class ResidentialBuilding : Building, rent
{
    public ResidentialBuilding(string date, int square, int floors) : base(date, square, floors) { }

    public int Rent(int price_per_meter, int square, int days)
    {
...
public class Cinema : PublicBuilding, ticket
{
...
public class Hotel : ResidentialBuilding, rent
{
